...
namespace UI
{
    class GalleryMenu: BaseMenu
    {
        ...
        public override void Setup()
        {
            ...
            _picture = ElementFactory.InstantiateAndBind(transform, "GalleryImage");
        ...
        public void LoadGallery(int index)
        {
            ...
            if (isBackground)
            {
                ...
                SetBackground("MainBackground" + (index + 1).ToString() + "Texture");
            }
            else
            {
                _picture.GetComponent<Image>().color = new Color(0.75f, 0.75f, 0.75f, 0f);
                SetBackground(UIManager.AvailableProfileIcons[index] + "IconFull");
            }
        }
        ...
        public void SetBackground(string image)
        {
            ...
            try
            {
                ...
                background.texture = (Texture2D)AssetBundleManager.LoadAsset(image);
