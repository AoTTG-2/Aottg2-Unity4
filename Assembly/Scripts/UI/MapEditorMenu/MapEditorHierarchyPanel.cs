...
namespace UI
{
    class MapEditorHierarchyPanel: HeadedPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            ElementFactory.CreateIconButton(_topGroup, _style, "ArrowLeftIcon", onClick: () => OnPageClick(true), elementHeight: 18f, elementWidth: 18f);
            ElementFactory.CreateIconButton(_topGroup, _style, "ArrowRightIcon", onClick: () => OnPageClick(false), elementHeight: 18f, elementWidth: 18f);
        ...
        private GameObject CreateMapItem(MapObject obj, int level)
        {
            ...
            var go = ElementFactory.InstantiateAndBind(SinglePanel, "MapEditorHierarchyButton");
            _items.Add(go);
