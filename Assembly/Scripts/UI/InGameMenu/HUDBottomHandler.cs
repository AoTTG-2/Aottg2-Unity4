    ...
    class HUDBottomHandler : MonoBehaviour
    {
        ...
        private void UpdateBlade()
        {
            ...
            else if (currBladeCount < weapon.BladesLeft)
            {
                ...
                {
                    {
                        _bladeAmmoLeft.Add(ElementFactory.InstantiateAndBind(_bladeAmmoGroupLeft.transform, "HUDBladeAmmo"));
                        var right = ElementFactory.InstantiateAndBind(_bladeAmmoGroupRight.transform, "HUDBladeAmmo");
