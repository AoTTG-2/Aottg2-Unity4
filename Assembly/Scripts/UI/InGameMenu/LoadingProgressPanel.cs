...
namespace UI
{
    class LoadingProgressPanel: BasePopup
    {
        ...
        protected override float Height => 190f;
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            ElementFactory.CreateDefaultButton(BottomBar, buttonStyle, UIManager.GetLocaleCommon("Quit"), onClick: () => OnButtonClick("Quit"));
            GameObject slider = ElementFactory.InstantiateAndBind(SinglePanel, "LoadingSlider");
