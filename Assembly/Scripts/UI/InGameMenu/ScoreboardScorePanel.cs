...
namespace UI
{
    class ScoreboardScorePanel: ScoreboardCategoryPanel
    {
        ...
        private Transform CreateRow(ElementStyle style, int index)
        {
            ...
            ElementFactory.CreateRawImage(playerRow, style, "BladeIcon");
            ...
            ElementFactory.CreateIconButton(actionRow, style, "UserIcon", elementWidth: 26f, elementHeight: 26f, onClick: () => OnClickProfile(index));
            ...
            if (PhotonNetwork.isMasterClient)
                ElementFactory.CreateIconButton(actionRow, style, "CloseIcon", elementWidth: 24f, elementHeight: 24f, onClick: () => OnClickKick(index));
        ...
        {
            // read player props
            string name = ChatManager.GetIDString(player.ID, player.isMasterClient) + player.GetStringProperty(PlayerProperty.Name);
        ...
        private void FinishKickPlayer(PhotonPlayer player)
        {
