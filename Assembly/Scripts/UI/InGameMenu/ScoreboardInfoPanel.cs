...
namespace UI
{
    class ScoreboardInfoPanel: ScoreboardCategoryPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            {
                ElementFactory.CreateDefaultLabel(DoublePanelLeft, style, "Room name: " + PhotonNetwork.room.GetStringProperty(RoomProperty.Name), alignment: TextAnchor.MiddleLeft);
                ElementFactory.CreateDefaultLabel(DoublePanelLeft, style, "Max players: " + PhotonNetwork.room.maxPlayers.ToString(), alignment: TextAnchor.MiddleLeft);
            }
