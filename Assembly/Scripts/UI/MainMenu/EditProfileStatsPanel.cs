...
namespace UI
{
    class EditProfileStatsPanel: CategoryPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            CreateStatLabel(DoublePanelRight, style, "Gun", stat.TitansKilledGun.Value.ToString());
            ...
            CreateStatLabel(DoublePanelRight, style, "Gun", stat.HumansKilledGun.Value.ToString());
