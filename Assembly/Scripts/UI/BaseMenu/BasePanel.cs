...
namespace UI
{
    class BasePanel : MonoBehaviour
    {
        ...
        {
            GameObject panel = AssetBundleManager.InstantiateAsset<GameObject>("SinglePanelContent");
        ...
        {
            GameObject panel = AssetBundleManager.InstantiateAsset<GameObject>("DoublePanelContent");
