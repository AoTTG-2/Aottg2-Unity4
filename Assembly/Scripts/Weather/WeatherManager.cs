...
namespace Weather
{
    class WeatherManager : MonoBehaviour
    {
        ...
        public static void Init()
        {
            ...
            EventManager.OnFinishInit += ThunderWeatherEffect.OnFinishInit;
        ...
        private void SyncWeather()
        {
            ...
            if (PhotonNetwork.isMasterClient)
            {
                RPCManager.PhotonView.RPC("SetWeatherRPC", PhotonTargets.Others, new object[]{ StringCompression.Compress(_currentWeather.SerializeToJsonString()),
