...
namespace Characters
{
    class Horse: BaseCharacter
    {
        ...
        {
            if (toggle && !HorseCache.Dust.enableEmission)
                HorseCache.Dust.enableEmission = true;
            else if (!toggle && HorseCache.Dust.enableEmission)
                HorseCache.Dust.enableEmission = false;
        }
