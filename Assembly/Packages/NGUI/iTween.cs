...
public class iTween : MonoBehaviour
{
    ...
    private sealed class StartcIteratorE : IEnumerator, IDisposable, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            {
                case 0:
                    if (this.fthis.delay <= 0f)
                    {
                        break;
                    }
                    this.Scurrent = this.fthis.StartCoroutine("TweenDelay");
                    this.SPC = 1;
                    return true;
    ...
    private sealed class TweenDelaycIteratorC : IEnumerator, IDisposable, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            {
                case 0:
                    this.fthis.delayStarted = Time.time;
                    this.Scurrent = new WaitForSeconds(this.fthis.delay);
                    this.SPC = 1;
                    return true;

                case 1:
                    if (this.fthis.wasPaused)
                    {
                        this.fthis.wasPaused = false;
                        this.fthis.TweenStart();
                    }
                    this.SPC = -1;
                    break;
